...
updater.addon = "blender_project_manager"
...
#	Jump to line 60 after setting updater.user, updater.repo and updater.website
#   Jump to line 980, if you want to hide the minutes/hours intervals
    ...
    updater.version_min_update = (1,2,0)
